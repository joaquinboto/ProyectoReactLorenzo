...
const WhoIAm = () => {
	...
	return (
		<motion.div variants={variants} initial="initial" animate="in" exit="out" transition={pageTransition} className="docs">
			<div>
				<h1 className="h1Who">Who am i?</h1>
				<p className="pWho">Hi my name is Lorenzo and I am a quant. After studying Law and Finance at Argentina, I found out in programming my passion to bring into a reality my imagination. End up being a developer that grabs a necessity and see it as a opportunity to solve it.</p>
